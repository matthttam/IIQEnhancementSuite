...
const saveOptions = () => {
    ...
    const IIQES_TICKET_TITLE = document.getElementById('IIQES_TICKET_TITLE').checked;
    ...
    chrome.storage.sync.set(
        {
            ...
            IIQES_TICKET_TITLE: IIQES_TICKET_TITLE
        },
        () => {
...
const restoreOptions = () => {
    chrome.storage.sync.get(
        ...
        (items) => {
            ...
            document.getElementById('IIQES_TICKET_TITLE').checked = items.IIQES_TICKET_TITLE;
        }
    );
};
