...
const saveOptions = () => {
    ...
    const IIQES_BatchCheckIn_PreventOverwrite = document.getElementById('IIQES_BatchCheckIn_PreventOverwrite').checked;
    ...
    chrome.storage.sync.set(
        {
            ...
            IIQES_BatchCheckIn_PreventOverwrite: IIQES_BatchCheckIn_PreventOverwrite
        },
        () => {
...
const restoreOptions = () => {
    chrome.storage.sync.get(
        ...
        (items) => {
            ...
            document.getElementById('IIQES_BatchCheckIn_PreventOverwrite').checked = items.IIQES_BatchCheckIn_PreventOverwrite;
        }
    );
};
